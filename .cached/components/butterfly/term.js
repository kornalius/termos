(function() {
  var EventEmitter, PropertyAccessors, State, Terminal, cancel, s,
  ...
  Terminal = (function(superClass) {
    ...
    PropertyAccessors.includeInto(Terminal);

    function Terminal(parent, out1, ctl, scrollback, buffSize) {
      var div;
      this.parent = parent;
      this.out = out1;
      this.ctl = ctl != null ? ctl : (function() {});
      this.scrollback = scrollback != null ? scrollback : 1000000;
      this.buffSize = buffSize != null ? buffSize : 100000;
      EventEmitter(this);
      ...
      this.rows = Math.floor(this.body.clientHeight / this.charSize.height);
      this.cursor = {
        nextLine: (function(_this) {
          return function(n) {
            ...
            _this.cursorNextLine([n]);
            _this.updateCursor();
            return _this.cursor;
          };
        })(this),
        prevLine: (function(_this) {
          return function(n) {
            if (n == null) {
              n = 1;
            }
            _this.cursorPrecedingLine([n]);
            _this.updateCursor();
            return _this.cursor;
          };
        })(this),
        ...
        nextStop: (function(_this) {
          return function(n) {
            if (n == null) {
              n = 1;
            }
            _this.cursorForwardTab([n]);
            _this.updateCursor();
            return _this.cursor;
          };
        })(this),
        prevStop: (function(_this) {
          return function(n) {
            if (n == null) {
              n = 1;
            }
            _this.cursorBackwardTab([n]);
            _this.updateCursor();
            return _this.cursor;
          };
        })(this),
        clearStop: (function(_this) {
          return function() {
            _this.tabClear([0]);
            _this.refresh();
            return _this.cursor;
        ...
        eraseRight: (function(_this) {
          return function(x, y) {
            _this.eraseRight(x, y);
            _this.refresh();
            return _this.cursor;
          };
        })(this),
        eraseLeft: (function(_this) {
          return function(x, y) {
            _this.eraseLeft(x, y);
            _this.refresh();
            return _this.cursor;
        ...
        eraseDown: (function(_this) {
          return function() {
            _this.eraseInDisplay([0]);
            _this.refresh();
            return _this.cursor;
          };
        })(this),
        eraseUp: (function(_this) {
          return function() {
            _this.eraseInDisplay([1]);
            _this.refresh();
            return _this.cursor;
          };
        })(this),
        eraseScreen: (function(_this) {
          return function() {
            _this.eraseInDisplay([2]);
            _this.refresh();
            return _this.cursor;
          };
        })(this),
        insertChars: (function(_this) {
          return function(n) {
            if (n == null) {
              n = 1;
            }
        ...
        insertColumns: (function(_this) {
          return function(n) {
            if (n == null) {
              n = 1;
            }
            _this.insertColumns([n]);
            _this.refresh();
            return _this.cursor;
          };
        })(this),
        insertLines: (function(_this) {
          return function(n) {
            if (n == null) {
              n = 1;
            }
        ...
        deleteColumns: (function(_this) {
          return function(n) {
            if (n == null) {
              n = 1;
            }
            _this.deleteColumns([n]);
            _this.refresh();
            return _this.cursor;
          };
        })(this),
        deleteLines: (function(_this) {
          return function(n) {
            if (n == null) {
              n = 1;
            }
        ...
        fill: (function(_this) {
          return function(x, y, w, h, ch, attr) {
            var chars, i, line;
            if (ch == null) {
              ch = null;
            }
            ...
            while (y < y + h) {
              line = _this.screen[y + _this.shift];
              chars = line.chars;
              line.dirty = true;
              i = x;
              while (i < x + w) {
                line[i] = _this.cloneAttr(attr || line[i].attr, ch || line[i].ch);
                i++;
              }
              y++;
            }
        ...
        eraseRectangle: (function(_this) {
          return function(x, y, w, h) {
            _this.eraseRectangle([y, x, y + h - 1, x + w - 1]);
            _this.refresh();
            return _this.cursor;
          };
        })(this),
        home: (function(_this) {
          ...
          return function() {
            _this.cursorPos([_this.rows, _this.cols]);
            _this.updateCursor();
            return _this.cursor;
          };
        })(this),
        ...
        eol: (function(_this) {
          return function() {
            _this.cursorPos([_this.y, _this.cols]);
            _this.updateCursor();
            return _this.cursor;
          };
        })(this),
    ...
    Terminal.prototype.color = require('crayon-terminal');

    Terminal.prototype.icons = require('./icons');

    Terminal.prototype.framer = function() {
      var f;
      f = require('./framer');
      ...
      })(f, [this].concat(slice.call(arguments)), function(){});
    };

    Terminal.prototype.spinner = function() {
      s = require('./spinner');
      return (function(func, args, ctor) {
        ctor.prototype = func.prototype;
        var child = new ctor, result = func.apply(child, args);
        return Object(result) === result ? result : child;
      })(s, [this].concat(slice.call(arguments)), function(){});
    };

    Terminal.prototype.box = require('box-chars');

    Terminal.prototype.table = require('table')["default"];

    Terminal.prototype.hasAnsi = require('has-ansi');

    Terminal.prototype.stripAnsi = require('strip-ansi');

    Terminal.prototype.center = require('center-text');

    Terminal.prototype.linewrap = require('linewrap');

    Terminal.prototype.success = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.color.green("✔ " + (args.join(' ')));
    };

    Terminal.prototype.warning = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.color.yellow("⚠ " + (args.join(' ')));
    };

    Terminal.prototype.error = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.color.red("✖ " + (args.join(' ')));
    };

    Terminal.prototype.info = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.color.cyan("ℹ " + (args.join(' ')));
    };
    ...
    Terminal.prototype.equalAttr = function(a, b) {
      return a.bg === b.bg && a.fg === b.fg && a.bold === b.bold && a.underline === b.underline && a.italic === b.italic && a.blink === b.blink && a.inverse === b.inverse && a.invisible === b.invisible && a.font === b.font;
    };
    ...
    Terminal.prototype.resize = function(x, y) {
      var el, i, j, line, oldCols, oldRows;
      if (x == null) {
        x = null;
      }
      if (y == null) {
      ...
      this.rows = y || Math.floor(this.body.clientHeight / this.charSize.height);
    ...
    Terminal.prototype.eraseRight = function(x, y) {
      ...
      this.screen[y + this.shift].wrap = false;
      return this.refresh();
    };
